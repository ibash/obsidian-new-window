...
var et = (c, u, h, A) => {
    if (u && typeof u == "object" || typeof u == "function")
        for (let x of Xe(u)) !Ye.call(c, x) && x !== h && Le(c, x, {
            get: () => u[x],
...
`)) this.add(h)
    ...
    add(u) {
        ...
        if (u[0] === "|" && u[1] === "|") {
            ...
            let E = u.slice(2);
            h.text = Ue(E)
        } else u[0] === "|" ? (h.hasStart = !0, h.text = u.slice(1)) : u[u.length - 1] === "|" && (h.hasEnd = !0, h.text = u.slice(0, -1));
...
function He(c, u, h) {
    ...
    } = h, C = h.selectionText.trim(), O = C.length > 0, T = !!h.linkURL, I = M => A[`can${M}`] && O, q = h.isEditable || O, L = [...j(v, () => [{
...
module.exports = function(c, u, h) {
    ...
    i.app.commandLine.appendSwitch("enable-features", A.join(",")), process.on("uncaughtException", function(e) {
...
` + (e.stack ? e.stack : `${e.name}: ${e.message}`);
    ...
    let x = "",
        E = !1;
    u.on("update-manual-required", () => x = "update-manual-required"), u.on("update-downloaded", () => x = "update-downloaded"), u.on("check-start", () => E = !0), u.on("check-end", () => E = !1);
    ...
    async function Z() {
        ...
        q = l, ne !== null && clearTimeout(ne), o !== 0 && (o = Math.min(o, 24), ne = setTimeout(Z, o * 864e5))
    }
...
Link: ` + qe(o, 200),
            ...
            t && s.checkboxChecked && (b.openSchemes = b.openSchemes || {}, b.openSchemes[t] = !0, k())
        }
        if (t === "http" || t === "https") {
            let s = "tab",
                f = !1;
            l === "new-window" ? (s = "window", f = !0) : a === "split" ? (s = "split", f = !0) : l === "background-tab" ? (s = "tab", f = !1) : l === "foreground-tab" && (s = "tab", f = !0);
            let y = `(() => {let e = new CustomEvent('open-url', ${JSON.stringify({cancelable:!0,detail:{url:o,leaf:s,active:f}})}); window.dispatchEvent(e); return e.defaultPrevented;})()`;
        ...
        let n = o.lastIndexOf("#"),
            r = "";
        n !== -1 && (r = o.substr(n), o = o.substr(0, n)), o = decodeURIComponent(o.substr(ie.length)), o = D.normalize(o) + r, !(_e(o) && (await i.dialog.showMessageBox(e, {
...
Location: ` + o,
    ...
    function De(e, o) {
        let l = e.webContents;
        we(l), ye(l), l.on("will-navigate", (t, n) => {
            ...
            e.focusTime = Date.now(), te(), pe(J(e), "window-always-on-top", {
    ...
    function we(e) {
        e.isSecured || (e.isSecured = !0, e.setWindowOpenHandler(o => {
            ...
            delete l.preload, delete l.preloadURL, l.sandbox = !0, l.nodeIntegration = !1, l.nodeIntegrationInWorker = !1, l.nodeIntegrationInSubFrames = !1, l.webSecurity = !0, l.plugins = !1, l.experimentalFeatures = !1, l.webviewTag = !1
    ...
    function Fe(e) {
        ...
        U(() => {
            ...
            o.width = Math.min(1024, a.width), o.height = Math.min(800, a.height - 1)
        });
        let l = !1;
        if (e.x !== void 0 && e.y !== void 0 && e.width !== void 0 && e.height !== void 0) try {
            ...
            console.error(a)
        } else e.x === void 0 && e.y === void 0 && e.width !== void 0 && e.height !== void 0 && (l = !0);
    ...
    let Je = D.join(O, "Obsidian Vault"),
        ...
        se = oe + je(36) + "/",
        Ae = V + "index.html",
        Ee = ["https://easylist.to/easylist/easylist.txt", "https://easylist.to/easylist/easyprivacy.txt"],
        Se = 4,
    ...
    for (let e in F) {
        let o = F[e];
        o.path = D.resolve(o.path), (!o.path || o.path === Ke || !g.existsSync(o.path)) && (delete F[e], ge(e))
    }
    b.vaults = F, b.insider && u.emit("insider", !0);
    let Q = b.frame === "native",
        le = Q ? "default" : "hidden";
    if (b.updateDisabled && (u.emit("disable", !0), console.log("Updates disabled.")), b.disableGpu && !i.app.isReady()) try {
        i.app.disableHardwareAcceleration(), console.log("GPU Acceleration disabled.")
    } catch (e) {
        console.error(e)
    }
    let P;
    b.icon && g.existsSync(D.join(C, b.icon)) && (P = D.join(C, b.icon)), !P && h && (P = D.join(c, "icon-dev.png"));
...
${s}`)
    ...
    function K(e) {
        ...
        let d = a.webContents,
            ...
            n = () => {
                if (t) return;
                t = !0, o.isMaximized && a.maximize(), o.devTools && d.openDevTools(), a.show();
                let m = o.zoom;
        ...
        function s() {
            try {
                let m = a.getBounds();
                r() && (o.x = m.x, o.y = m.y, o.width = m.width, o.height = m.height), o.isMaximized = a.isMaximized(), o.devTools = d.isDevToolsOpened(), o.zoom = d.zoomLevel
            } catch (m) {}
        }
        ...
        f(d), a.on("close", m => {
            ...
            delete B[e], !ue && i.BrowserWindow.getAllWindows().length > 0 && ve(e, !1)
        });
        let p;
        ...
        }), a.loadURL(Ae).then(n, n), ve(e, !0), a
    }
    ...
    function Te(e) {
        ...
        return P && !v && U(() => o.setIcon(P)), ye(o.webContents), o.menuBarVisible = !1, o.on("focus", () => {
            te()
        }), o
    }
    let _;
    ...
    i.app.whenReady().then(() => {
        i.app.on("second-instance", (t, n) => {
            ...
            let r = t.url,
                s = !1;
            r.indexOf("?") > 0 && (r = r.substr(0, r.indexOf("?"))), r.indexOf("#") > 0 && (r = r.substr(0, r.indexOf("#"))), r.indexOf(V) === 0 ? (r = decodeURIComponent(r.substr(V.length)), r = D.resolve(D.join(c, r)), r.indexOf(D.resolve(c)) !== 0 && (r = ""), s = !0) : r.indexOf(se) === 0 ? (r = decodeURIComponent(r.substr(se.length)), N || (r = "/" + r), r = D.resolve(r), _e(r) && (s = !0)) : r = "";
            let f = {};
            s && (f["X-Frame-Options"] = "DENY"), n({
                path: r,
                headers: f
            })
            ...
            t.returnValue = "", console.log("Relaunching!"), ue = !0, i.app.relaunch(), i.app.quit()
        }), i.ipcMain.on("update", t => {
            t.returnValue = x
        }), i.ipcMain.on("check-update", (t, n) => {
            n && (b.updateDisabled && u.emit("disable", !1), u.emit("check"), b.updateDisabled && setTimeout(() => u.emit("disable", !0), 50)), t.returnValue = E
        }), i.ipcMain.on("disable-update", (t, n) => {
            n === !0 ? (b.updateDisabled = !0, u.emit("disable", !0), k(), console.log("Updates disabled.")) : n === !1 && (delete b.updateDisabled, u.emit("disable", !1), k(), console.log("Updates enabled.")), t.returnValue = b.updateDisabled
        }), i.ipcMain.on("disable-gpu", (t, n) => {
            n === !0 ? (b.disableGpu = !0, k()) : n === !1 && (delete b.disableGpu, k()), t.returnValue = b.disableGpu
        }), i.ipcMain.on("insider-build", (t, n) => {
            n === !0 ? (b.insider = !0, u.emit("insider", !0), k()) : n === !1 && (delete b.insider, u.emit("insider", !1), k()), t.returnValue = b.insider
        }), i.ipcMain.on("frame", (t, n) => {
            typeof n == "string" && (b.frame = n, n || delete b.frame, k()), t.returnValue = b.frame
        }), i.ipcMain.on("adblock-lists", (t, n) => {
            Array.isArray(n) && (b.adblock = n, k(), Z()), t.returnValue = b.adblock || Ee
        }), i.ipcMain.on("adblock-frequency", (t, n) => {
            typeof n == "number" && (b.adblockFrequency = n, k(), Z()), t.returnValue = b.adblockFrequency || Se
            ...
            R.on("login", (w, S) => S()), R.on("error", w => {
                t.reply(n, {
                    error: w
                })
            }), R.on("response", w => {
                let S = [];
                w.on("data", W => S.push(W)), w.on("end", () => {
            ...
            try {
                typeof y == "string" ? R.write(y) : y instanceof ArrayBuffer && R.write(Buffer.from(new Uint8Array(y))), R.end()
            } catch (w) {
                t.reply(n, {
                    error: w
                })
            ...
            b.icon && g.rmSync(D.join(C, b.icon), {
                force: !0
            }), n && r ? g.writeFileSync(D.join(C, n), r) : n = null, (b.icon || "") !== (n || "") && (n ? b.icon = n : delete b.icon, k()), t.returnValue = null
            ...
            s || (r === !0 && Z(), s = {
                ...
                y(Oe.includes(p))
            }), s.session.setDevicePermissionHandler(f => !1)), (r === !0 || r === !1) && (s.adblock = r)
        });
        ...
        e.onBeforeRequest({
            ...
            f + "/" === V && (p = !1), f === "null" && r === r.top && s.startsWith(V) && (p = !1), n({
                cancel: p
            })
            ...
            let R = !1;
            for (let w in r) w.toLowerCase() === "access-control-allow-origin" && (R = !0), w.toLowerCase() === "x-frame-options" && delete r[w], w.toLowerCase() === "cross-origin-opener-policy" && delete r[w], w.toLowerCase() === "content-security-policy" && (r[w] = r[w].map(S => S.replace(/\s*frame-ancestors [^;]*(;|$)/g, ""))), w.toLowerCase() === "set-cookie" && m && (r[w] = r[w].map(S => /Secure;/i.test(S) ? S.replace(/SameSite=Lax/i, "SameSite=None") : S));
            n({
                responseHeaders: r
            })
        });
        let o = () => !1;
        e.onBeforeRequest = o, e.onBeforeSendHeaders = o, e.onHeadersReceived = o;
        for (let t of [i.protocol, i.session.defaultSession.protocol]) t.interceptBufferProtocol = o, t.interceptStreamProtocol = o, t.interceptStringProtocol = o, t.interceptFileProtocol = o, t.interceptHttpProtocol = o, t.handle = o;
        i.session.defaultSession.setPermissionRequestHandler((t, n, r, s) => {
            let f = t.getURL().startsWith(V);
            s.isMainFrame && s.requestingUrl === "about:blank" && n.startsWith("clipboard-") && (f = !0), n === "openExternal" ? f = !1 : n === "fullscreen" && (f = !0), f || console.log("Blocked permission request", t.getURL(), n, s), r(f)
        });
        ...
        function l(t) {
            if (t && typeof t == "string") {
                ...
                for (let r in F) {
                    let s = F[r];
                    if (s.path === t) return s.ts = Date.now(), K(r), i.app.addRecentDocument(t), !0
                }
                let n = je(16);
                return F[n] = {
                    path: t,
                    ts: Date.now()
                }, K(n), i.app.addRecentDocument(t), !0
            }
        ...
        function d(t, n) {
            ...
            for (let s of r) {
                let f = D.join(t, s),
                    p = g.statSync(f),
                    y = n + "/" + s;
                p.isFile() && g.writeFileSync(y, g.readFileSync(f)), p.isDirectory() && d(f, y)
            }
        }
        if (i.app.setAboutPanelOptions({
                ...
                we(n), n.noContextMenu = !1, n.hostWebContents && n.on("context-menu", (r, s) => {
            ...
            }), Pe(process.argv), ce && he(ce), i.app.on("open-url", function(t, n) {
                t.preventDefault(), he(n)
            }), Object.keys(B).length === 0) de();
        else {
    ...
    function he(e) {
        ...
        if (e.startsWith("/")) {
            ...
            f >= 0 && (r = e.substr(f + 1), e = e.substr(0, f), l.hash = r), s >= 0 && (n = e.substr(s + 1), e = e.substr(0, s));
            for (let p of n.split("&")) {
                let y = p.split("="),
                    m = !0;
                y.length > 1 && (m = decodeURIComponent(y[1])), l[decodeURIComponent(y[0])] = m
            }
    ...
    function Pe(e) {
        for (let o of e)
            if (o.startsWith("obsidian://")) return he(o), !0;
        return !1
    }
};
